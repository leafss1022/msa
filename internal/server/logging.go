...
func (a *App) LogInfo(caller, msg string, fields map[string]any) {
	a.logMSA("info", caller, msg, fields)
}

func (a *App) LogWarn(caller, msg string, fields map[string]any) {
	a.logMSA("warn", caller, msg, fields)
}

func (a *App) LogError(caller, msg string, fields map[string]any) {
	a.logMSA("error", caller, msg, fields)
}

func (a *App) logMSA(level, caller, msg string, fields map[string]any) {
	if a == nil || a.DataDir == "" {
		return
	}
	...
	path := filepath.Join(a.DataDir, "logs/msa.log")
