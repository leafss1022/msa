...
const PROXIES_SETTINGS_KEY = "msa-mihomo-proxies.settings";
const PROXIES_TAB_KEY = "msa-mihomo-proxies.tab";
const COLLAPSE_PREFIX = "msa-mihomo-proxies.collapse";
...
function normalizeProviderSources(payload: any): ProviderSource[] {
  ...
  return items
    ...
    .filter((item) => item.name !== "msa_manual" && item.type !== "file" && item.vehicleType !== "file")
