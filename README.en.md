...
- Docker deployments must mount a host data directory to container `/opt/msa`; the default examples use `./msa-data:/opt/msa`.

## Architecture Diagram

<p align="center">
  <img src="docs/png/framework-architecture.en.svg" alt="msa side-router proxy architecture diagram">
</p>
...
|---|---|---|---|
| Linux tarball/systemd | Stable | [Linux install](docs/install/linux.md) | `msa update` / `msa uninstall` |
...
`msa update` and `msa uninstall` are only for Linux tarball/systemd installs. fnOS FPK, Unraid PLG, and Docker installs must be updated or removed through their platform manager.
...
```text
https://github.com/leafss1022/msa/releases/tag/v0.4.1.0
```

| Asset | URL |
|---|---|
| Linux x86_64 | `https://github.com/leafss1022/msa/releases/download/v0.4.1.0/msa-linux-amd64.tar.gz` |
| Linux ARM64 | `https://github.com/leafss1022/msa/releases/download/v0.4.1.0/msa-linux-arm64.tar.gz` |
| fnOS x86 FPK | `https://github.com/leafss1022/msa/releases/download/v0.4.1.0/msa_0.4.1.0_x86.fpk` |
| fnOS ARM FPK | `https://github.com/leafss1022/msa/releases/download/v0.4.1.0/msa_0.4.1.0_arm.fpk` |
| Unraid PLG | `https://github.com/leafss1022/msa/releases/download/v0.4.1.0/msa.plg` |
...
4. Configure DHCP DNS and FakeIP static routes on your main router so LAN clients can use msa.
