...
| Asset | URL |
|---|---|
| Linux x86_64 | `https://github.com/leafss1022/msa/releases/download/v0.4.4.0/msa-linux-amd64.tar.gz` |
| Linux ARM64 | `https://github.com/leafss1022/msa/releases/download/v0.4.4.0/msa-linux-arm64.tar.gz` |
| fnOS x86 FPK | `https://github.com/leafss1022/msa/releases/download/v0.4.4.0/msa_0.4.4.0_x86.fpk` |
| fnOS ARM FPK | `https://github.com/leafss1022/msa/releases/download/v0.4.4.0/msa_0.4.4.0_arm.fpk` |
| Unraid PLG | `https://github.com/leafss1022/msa/releases/download/v0.4.4.0/msa.plg` |
