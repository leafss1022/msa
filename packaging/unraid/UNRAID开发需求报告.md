...
| 安装入口 `.plg` | 根目录 `msa.plg`（v0.2.2） | ✅ 指向 `scoltzero/msa` release |
...
1. **公开且持续维护的仓库**（已满足：`scoltzero/msa`，需确保 public）。
...
- [ ] `make unraid VERSION=0.2.x UNRAID_VERSION=0.2.x GITHUB_REPO=scoltzero/msa RELEASE_TAG=v0.2.x`
