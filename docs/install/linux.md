...
| 架构 | 下载地址 |
|---|---|
| x86_64 / amd64 | `https://github.com/leafss1022/msa/releases/download/v0.4.1.1/msa-linux-amd64.tar.gz` |
| ARM64 / aarch64 | `https://github.com/leafss1022/msa/releases/download/v0.4.1.1/msa-linux-arm64.tar.gz` |
...
curl -L -o msa-linux-amd64.tar.gz \
  https://github.com/leafss1022/msa/releases/download/v0.4.1.1/msa-linux-amd64.tar.gz

tar -xzf msa-linux-amd64.tar.gz -C /tmp
sudo /tmp/msa-0.4.1.1-linux-amd64/install.sh
```
...
curl -L -o msa-linux-arm64.tar.gz \
  https://github.com/leafss1022/msa/releases/download/v0.4.1.1/msa-linux-arm64.tar.gz

tar -xzf msa-linux-arm64.tar.gz -C /tmp
sudo /tmp/msa-0.4.1.1-linux-arm64/install.sh
```
