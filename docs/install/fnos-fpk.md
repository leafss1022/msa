...
| 架构 | FPK 资产 |
|---|---|
| x86 / amd64 | `https://github.com/leafss1022/msa/releases/download/v0.4.1.1/msa_0.4.1.1_x86.fpk` |
| ARM / arm64 | `https://github.com/leafss1022/msa/releases/download/v0.4.1.1/msa_0.4.1.1_arm.fpk` |
