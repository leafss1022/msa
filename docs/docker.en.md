...
This experimental image is not pushed as `latest`. To pull or deploy the Docker experimental version, explicitly use the `v0.4.1.1` tag.
...
2. Create a new container and set the image to `ghcr.io/leafss1022/msa:v0.4.1.1`.
...
|---|---|---|
| `MSA_IMAGE` | `ghcr.io/leafss1022/msa:v0.4.1.1` | Container image |
